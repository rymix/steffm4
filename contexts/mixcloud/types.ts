...
export type MixcloudContextState = {
  ...
  setMixProgress: React.Dispatch<React.SetStateAction<number>>;
  setMixProgressPercent: React.Dispatch<React.SetStateAction<number>>;
  ...
  setTrackProgressPercent: React.Dispatch<React.SetStateAction<number>>;
